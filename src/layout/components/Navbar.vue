<template>
  <div class="navbar">
    ...
    <el-dialog v-drag-dialog title="修改密码" :visible.sync="dialogVisible" width="30%" center :show-close="false">
      <el-form ref="changePasswordForm" :model="changePasswordForm" :rules="rules">
        <el-form-item label="旧密码" prop="oldPassword" label-width="85px">
          <el-input v-model="changePasswordForm.oldPassword" type="password" placeholder="新密码" />
        </el-form-item>
...
import { updateUserPassword } from '@/api/system/auth'
export default {
  components: {
    Breadcrumb,
    Hamburger,
